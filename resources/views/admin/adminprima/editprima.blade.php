...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-12 grid-margin stretch-card">
      <div class="card">
      <form action="{{ url('updatePrima', $prima->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                  ...
                  <select name="kategori_produk" class="form-control w-100" required>
                      ...
                      <option value="makanan" {{ old('kategori_produk', $prima->kategori_produk) == 'makanan' ? 'selected' : '' }}>Makanan dan Minuman</option>
                      <option value="kerajinan" {{ old('kategori_produk', $prima->kategori_produk) == 'kerajinan' ? 'selected' : '' }}>Kerajinan dan Aksesoris</option>
                  </select>
              </div>
              <!-- Input Nama Produk -->
              <div class="form-group">
                  <label for="nama_produk">Nama Produk</label>
                  <input type="text" class="form-control" id="namaProduk" name="nama_produk" value="{{ old('nama_produk', $prima->nama_produk) }}" required>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="harga_produk" value="{{ old('harga_produk', $prima->harga_produk) }}" oninput="formatCurrency(this)" required>
                  </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <input type="tel" class="form-control" id="whatsappNumber" name="nomor_whatsapp" value="{{ old('nomor_whatsapp', $prima->nomor_whatsapp) }}" placeholder="Masukkan Nomor WhatsApp" required>
              </div>

              <!-- Input Deskripsi -->
              <div class="form-group">
                  <label for="deskripsi">Deskripsi</label>
                  <textarea class="form-control" id="deskripsi" name="deskripsi" rows="5" required>{{ old('deskripsi', $prima->deskripsi) }}</textarea>
              </div>
              ...
              <div class="form-group">
                  ...
                  @if ($prima->foto_card)
                      <div style="margin-bottom: 15px;">
                          <img src="{{ asset('storage/' . $prima->foto_card) }}" alt="Foto Card" width="100" style="display: block; margin-bottom: 10px;">
                          <input type="hidden" name="existing_foto_card" value="{{ $prima->foto_card }}">
                      </div>
                  @endif
              ...
              <div class="form-group">
                  ...
                  @if (!empty($prima->foto_slider) && is_array(json_decode($prima->foto_slider, true)))
                      <div id="existing-photos" style="margin-bottom: 15px;">
                          @foreach (json_decode($prima->foto_slider, true) as $foto)
              ...
              <a href="{{ url('/kelolaprima') }}" class="btn btn-light">Kembali</a>
          </form>
        <script>
