                  ...
                  <div class="table-responsive">
                    <table class="table table-striped table-borderless">
                      ...
                      <tr>
                          ...
                          <td>
                              @php
                                  $waktuKunjung = json_decode($item->waktu_kunjung, true);
                              @endphp

                              @if(is_array($waktuKunjung))
                                  @foreach($waktuKunjung as $jadwal)
                                      <div>
                                          {{ $jadwal['hari'] }}: {{ $jadwal['jam_buka'] }} - {{ $jadwal['jam_tutup'] }}
                                      </div>
                                  @endforeach
                              @else
                                  -
                          ...
                          <td>
                              @php
                                  ...
                                  $fotoTerlihat = array_slice($fotoWisata, 0, 3); // Ambil 3 foto pertama
                              @endphp

                              @foreach($fotoTerlihat as $foto)
                                  <img src="{{ asset('storage/' . $foto) }}" alt="Foto Wisata" width="100">
                              @endforeach

                              @if(count($fotoWisata) > 3)
                                  <span>...dan lainnya</span> <!-- Tampilkan teks jika ada lebih banyak foto -->
                              @endif
                          </td>
                          <td>
