...
<html lang="en">
  ...
  <body>
    ...
    <a class="navbar-brand brand-logo me-5" href="{{ url('/adminkelurahan') }}"><img src="{{ asset('admin/assets/images/logo.svg') }}"class="me-2" alt="logo" /></a>
    <a class="navbar-brand brand-logo-mini" href="{{ url('/adminkelurahan') }}"><img src="{{ asset('admin/assets/images/logo-mini.svg') }}" alt="logo" /></a> 
  </div>
  ...
  <ul class="nav">
    <li class="nav-item">
      <a class="nav-link" href="{{ url('/adminkelurahan') }}">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-basic">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="{{ url('/ui-features/buttons') }}">Buttons</a></li>
          <li class="nav-item"> <a class="nav-link"  href="{{ url('/ui-features/dropdowns') }}">Dropdowns</a></li>
          <li class="nav-item"> <a class="nav-link" href="{{ url('/ui-features/typography') }}">Typography</a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
      <a class="nav-link" data-bs-toggle="collapse" href="{{ url('/form_elements') }}"aria-expanded="false" aria-controls="form-elements">
      ...
      <div class="collapse" id="form-elements">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"><a class="nav-link" href="{{ url('/forms/basic_elements') }}" html">Basic Elements</a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
      <a class="nav-link" data-bs-toggle="collapse" href="{{ url('/chartjs') }}" aria-expanded="false" aria-controls="charts">
