                ...
                <div class="row">
                    ...
                    <section class="contact-section">
                        ...
                        <div class="row" style="margin-top: 20px;">
                            <div class="col-24">
                                <h3 class="contact-title">Kesan dan Pesan</h3>
                            </div>
                        </div>
                        
                        <div class="col-lg-12">
                         <form class="form-contact contact_form" action="{{ url('/simpanFeedback') }}" method="POST" id="contactForm" novalidate="novalidate">
                        @csrf
                        <div class="row">
                            <div class="col-12">
