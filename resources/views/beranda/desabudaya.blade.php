...
<meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{{ asset('themewagon/css/desabudaya.css') }}">
...
<div class="carousel-container">
    ...
    @if($item->foto_card)
    <img src="{{ asset('storage/uploads/budaya/' . $item->foto_card) }}" alt="{{ $item->nama_budaya }}" class="card-img-top">
    @else
